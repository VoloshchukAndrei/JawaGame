...
public class Coordinates {
    ...
    public Coordinates newPosition(Coordinates targetPosition, ArrayList<Heroes> unitsAllies) {
    ...
    public boolean containsByPos(Coordinates nextPos, ArrayList<Heroes> unitsAllies) {
        for (Heroes unit: unitsAllies) {
